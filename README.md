...
Generates per-game `.tex` files, commentary files, a harness file, and consolidated figures. Output goes to `texfrog_output/` next to the input YAML by default.
...
texfrog_output/         # generated by: texfrog latex
    G0.tex
    G1.tex
    G0_commentary.tex
    proof_harness.tex
