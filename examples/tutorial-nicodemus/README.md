...
> [!NOTE]
> **Package:** This tutorial uses [`nicodemus`](../../texfrog/resources/nicodemus.sty) (by Bertram Poettering; not on CTAN, bundled with TeXFrog). For the same proof using `cryptocode` (the default, with a more detailed walkthrough), see [tutorial-cryptocode/](../tutorial-cryptocode/).
