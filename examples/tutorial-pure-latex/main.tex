...
\subsection*{Game $\tfgamename{G1}$ (with highlighting)}
\tfrendergame{indcpa}{G1}

\subsection*{Game $\tfgamename{G1}$ (clean, no highlighting)}
\tfrendergame[highlight=false]{indcpa}{G1}

\subsection*{Game $\tfgamename{G2}$ (with highlighting)}
\tfrendergame{indcpa}{G2}

\subsection*{Reduction $\tfgamename{Red1}$ (with highlighting)}
\tfrendergame{indcpa}{Red1}

\subsection*{Game $\tfgamename{G3}$ (with highlighting)}
